...
<body class="admin-body">
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="<?php echo $activePage == 'studentrecord.php' ? 'active_side' : ''; ?>">
                <a href="studentrecord.php">My Courses</a>
            </li>
            <li class="<?php echo $activePage == 'staffrecord.php' ? 'active' : ''; ?>">
                <a href="staffrecord.php"> Module</a>
            </li>
            <li class="<?php echo $activePage == 'course_record.php' ? 'active' : ''; ?>">
                <a href="course_record.php">Assignments</a>
            </li>
            <li class="<?php echo $activePage == 'module_record.php' ? 'active' : ''; ?>">
                <a href="module_record.php">calander</a>
            </li>
            <li class="<?php echo $activePage == 'assignment.php' ? 'active' : ''; ?>">
                <a href="assignment.php">Grades</a>
            </li>
